              ...
              <div className="text-left">
                ...
                <p className="text-sm text-[#3C2317]/80 max-w-3xl text-pretty leading-relaxed mb-4">
                  ...
                  {isDescriptionExpanded && (
                    <>
                      {" "}
                      Nomadic's Desert BBQ setups were created for those who want an immersive, private desert
                      experience without the stress of organizing equipment or logistics. Every setup is fully prepared
                      before you arrive - all you need to bring is your food, drinks, charcoal, and firewood (or add
                      them to your booking). Each BBQ setup is exclusive to your booking - just you, your group and the
                      serenity of the desert night. Your setup includes everything you need for the perfect desert BBQ:
                      comfortable floor seating with cushions, chairs, lighting, raised BBQ and fire pit, butane gas
                      stove, cooking utensils, plates, cutlery, and a cooler box for your refreshments. Simply arrive,
                ...
                <Button
                  ...
                  className="text-[#3C2317] hover:text-[#3C2317] hover:bg-[#D3B88C]/20 font-semibold text-sm mb-4 p-0 h-auto"
                >
