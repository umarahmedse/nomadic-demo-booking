                ...
                {!dateConstraints?.blocked && (
                  <>
                    ...
                    >
                      ...
                      <CardContent className="p-3 sm:p-4 space-y-3 !pt-0">
                  ...
                  <div className="space-y-3 sm:space-3">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold text-[11px] sm:text-xs text-[#3C2317]">
                        AED {(() => {
                          const locationConfig = settings?.locations?.find(
                            (loc) => loc.name.toLowerCase() === formData.location.toLowerCase(),
                          )
                          return (locationConfig?.weekdayPrice || DEFAULT_SETTINGS.tentPrice).toFixed(2)
                        })()} + VAT
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold text-[11px] sm:text-xs text-[#3C2317]">
                        AED {(() => {
                          ...
                          return (locationConfig?.weekendPrice || DEFAULT_SETTINGS.tentPrice + 200).toFixed(2)
                        })()} + VAT
                      </span>
                    </div>
