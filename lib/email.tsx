...
export async function sendBookingConfirmation(booking) {
  ...
  <div style="margin-top:25px;background:#FFF9F0;border:1px solid #EADAC1;border-radius:10px;padding:20px;color:#3C2317;line-height:1.6;font-size:15px;">
    ...
    <p>It is important that you arrive at <strong>4:30pm on time</strong> so our team can guide you to your camp. Nomadic camping sites can sometimes be difficult to access by saloon car.</p>
    <p>If you don’t have a 4x4, you can park near the meeting spot, and our team will transport you and your belongings to camp. 4x4 vehicles will have no issue reaching the site.</p>
    ...
    html: `
      <div style="font-family:'Inter',Arial,sans-serif;background-color:#FFF7E8;color:#3C2317;max-width:700px;margin:auto;border-radius:16px;overflow:hidden;box-shadow:0 6px 16px rgba(0,0,0,0.08);">
        ...
        <div style="padding:24px;">
          ...
          <p>Thank you for choosing <strong>Nomadic Camping</strong>. Your desert adventure is confirmed!</p>
          ...
          <div style="margin:16px 0;border:1px solid #EADAC1;border-radius:10px;overflow:hidden;">
            <table style="width:100%;border-collapse:collapse;font-size:14px;">
              ...
              <tr>
                ...
                <td style="padding:10px;">${booking.location}</td>
              </tr>
              <tr style="background:#FDF7EC;">
